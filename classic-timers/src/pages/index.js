...
export default function Home() {
  return (
    <main className={`flex min-h-screen flex-col items-center p-5 ${inter.className}`}>
        <h1 class="font-bold text-4xl mb-2">Simple SoD Timers (US - Living Flame)</h1>
        <div className="bg-neutral-800/50 border border-neutral-600 border-1 w-3/12 rounded-lg p-5 m-2">
